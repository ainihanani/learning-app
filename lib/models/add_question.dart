...
class _AddQuestionState extends State<AddQuestion> {
  ...
  // Using the 'late' keyword to indicate these variables will be initialized before use.
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text("Add Question", style: TextStyle(fontSize: 16, color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
